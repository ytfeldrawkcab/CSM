...
DATABASES = {
    'default': {
        ...
        'NAME': 'database/sqlite3.db',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/home/ytfeldrawkcab/CSM/static/'
...
SECRET_KEY = '^_w9+v@o0)=6t_we9*#g^e-__8sk1q@ui8(upo(g#mt7v^jp)#'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/home/ytfeldrawkcab/CSM/templates"
)
